...
#import "ZWURLRouterFilter.h"
#import <UIKit/UIKit.h>

extern NSString *const ZWMGJRouterParameterURL;
extern NSString *const ZWMGJRouterParameterCompletion;
extern NSString *const ZWMGJRouterParameterUserInfo;
extern NSString *const ZWMGJRouterParameterOnlyObject;

/**
 *  routerParameters 里内置的几个参数会用到上面定义的 string
 */
typedef void (^ZWMGJRouterHandler)(NSDictionary *routerParameters);

/**
 *  需要返回一个 object，配合 objectForURL: 使用
 */
typedef id (^ZWMGJRouterObjectHandler)(NSDictionary *routerParameters);

@interface ZWMGJRouter : NSObject
 ...
 *  [ZWMGJRouter generateURLWithPattern:MGJ_ROUTE_BEAUTY, @[@13]];
 *
 *
